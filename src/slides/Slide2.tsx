    ...
    <div className="slide2-root ai-hero-bg">
      ...
      <div className="slide2-right">
        <div className="slide2-title-box">
          ...
          >
            Что такое&nbsp;искусственный интеллект?</h1>
        </div>
        ...
        <div className="slide2-block">
          ...
          >
            ...
            создающая системы, которые выполняют задачи, требующие человеческого
            интеллекта: анализ, обучение, принятие решений, распознавание образов.
          </p>
        </div>
        ...
        <div className="slide2-block">
          <h2
            className="slide2-subtitle"
            style={{ fontFamily: "PoppinsSemiBold" }}
          >Современный "узкий" ИИ</h2>
          <p
            className="slide2-text"
            style={{ fontFamily: "PoppinsRegular" }}
          >
            Большинство реальных систем — узкий ИИ: модели для речи, поиска,
            рекомендаций, медицины. Они не обладают сознанием и эмоциями, а лишь
            обрабатывают данные по заданным алгоритмам — это важно для
            последующих философских вопросов.
          </p>
        </div>
        <div className="slide2-block">
          <h2
